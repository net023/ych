...
public class ReflectKit {
	 ...
	 * @see #on(Class)
	 */
	public static ReflectKit on(String name) throws ReflectException {
	 ...
	 * Wrap a class.
	 * <p>
	 * Use this when you want to access static fields and methods on a {@link Class} object, or as a basis for constructing objects of that class using {@link #create(Object...)}
	 * 
	 * @param clazz
	 ...
	 * Set a field value.
	 * <p>
	 * This is roughly equivalent to {@link Field#set(Object, Object)}. If the wrapped object is a {@link Class}, then this will set a value to a static member field. If the wrapped object is any
	 * other {@link Object}, then this will set a value to an instance member field.
	 * 
	 * @param name
	 *            The field name
	 * @param value
	 ...
	 *             If any reflection exception occurred.
	 */
	public ReflectKit set(String name, Object value) throws ReflectException {
		try {
	 ...
	 * Get a field value.
	 * <p>
	 * This is roughly equivalent to {@link Field#get(Object)}. If the wrapped object is a {@link Class}, then this will get a value from a static member field. If the wrapped object is any other
	 * {@link Object}, then this will get a value from an instance member field.
	 * <p>
	 ...
	 * Get a wrapped field.
	 * <p>
	 * This is roughly equivalent to {@link Field#get(Object)}. If the wrapped object is a {@link Class}, then this will wrap a static member field. If the wrapped object is any other {@link Object},
	 * then this wrap an instance member field.
	 * 
	 * @param name
	 *            The field name
	 ...
	 *             If any reflection exception occurred.
	 */
	public ReflectKit field(String name) throws ReflectException {
		try {
	...
	public Map<String, ReflectKit> fields() {
		Map<String, ReflectKit> result = new LinkedHashMap<String, ReflectKit>();
	 ...
	 */
	public ReflectKit call(String name) throws ReflectException {
	 ...
	 * Call a method by its name.
	 * <p>
	 * This is roughly equivalent to {@link Method#invoke(Object, Object...)}. If the wrapped object is a {@link Class}, then this will invoke a static method. If the wrapped object is any other
	 * {@link Object}, then this will invoke an instance method.
	 * <p>
	 * Just like {@link Method#invoke(Object, Object...)}, this will try to wrap primitive types or unwrap primitive type wrappers if applicable. If several methods are applicable, by that rule, the
	 * first one encountered is called. i.e. when calling <code><pre>
	 * on(...).call("method", 1, 1);
	 ...
	 *             If any reflection exception occurred.
	 */
	public ReflectKit call(String name, Object... args) throws ReflectException {
	 ...
	 * <p>
	 * If a public method is found in the class hierarchy, this method is returned. Otherwise a private method with the exact same signature is returned. If no exact match could be found, we let the
	 ...
	 * <p>
	 * First public methods are searched in the class hierarchy, then private methods on the declaring class. If a method could be found, it is returned, otherwise a {@code NoSuchMethodException} is
	 * thrown.
	 */
	 ...
	 * @see #create(Object...)
	 */
	public ReflectKit create() throws ReflectException {
	 ...
	 * Call a constructor.
	 * <p>
	 * This is roughly equivalent to {@link Constructor#newInstance(Object...)}. If the wrapped object is a {@link Class}, then this will create a new object of that class. If the wrapped object is
	 * any other {@link Object}, then this will create a new object of the same type.
	 * <p>
	 * Just like {@link Constructor#newInstance(Object...)}, this will try to wrap primitive types or unwrap primitive type wrappers if applicable. If several constructors are applicable, by that
	 * rule, the first one encountered is called. i.e. when calling <code><pre>
	 ...
	 *             If any reflection exception occurred.
	 */
	public ReflectKit create(Object... args) throws ReflectException {
		Class<?>[] types = types(args);
	...
	public boolean equals(Object obj) {
		if (obj instanceof ReflectKit) {
			return object.equals(((ReflectKit) obj).get());
		}
	 ...
	 */
	private static ReflectKit on(Constructor<?> constructor, Object... args) throws ReflectException {
		try {
	 ...
	 */
	private static ReflectKit on(Method method, Object object, Object... args) throws ReflectException {
		try {
			accessible(method);
