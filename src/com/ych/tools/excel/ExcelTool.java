...
public class ExcelTool {
	...
	private static void writeToRow(List<?> datas, List<String> percentNoConvert, HashMap anyTemp, ArrayList<String> fields, HSSFSheet sheet, HSSFCellStyle style, NumberFormat format,int starIndex) {
